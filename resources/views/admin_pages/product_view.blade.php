...
@endsection
@section('page_style')
    <link rel="stylesheet" href="{{ asset('admin_pages/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{ asset('admin_pages/css/dataTables.css')}}">
    <link rel="stylesheet" href="{{ asset('admin_pages/css/dataTables.tableTools.css')}}">
@endsection
@section('page_script')
    <script src="{{ asset('admin_pages/js/jquery.magnific-popup.min.js')}}"></script>
